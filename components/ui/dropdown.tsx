...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded-md border border-neutral-200 bg-white p-1 shadow-lg",
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-peri-50 focus:text-peri-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
...
export { Check as CheckIcon, ChevronRight as ChevronRightIcon };
